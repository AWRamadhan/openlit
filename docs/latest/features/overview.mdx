...
<CardGroup cols={2}>
    ...
    <Card title="Prompt Hub" href="/latest/features/openai/openlit/prompt-hub" icon='comments'>
    Manage prompts centrally, fetch versions, and use variables for dynamic prompts.
    </Card>

    <Card title="Vault" href="/latest/features/openai/openlit/vault" icon='vault'>
    ...
    <Card title="Exceptions Monitoring" href="/latest/features/openai/openlit/exceptions" icon='bug'>
    Automatically track and view detailed error stack traces in your app.
    </Card>

    <Card title="OpenGround" href="/latest/features/openai/openlit/openground" icon='codepen'>
