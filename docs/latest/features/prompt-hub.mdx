    ...
    <Steps>
      ...
      <Step title="Get prompt using the SDK">
        <Tabs>
          ...
          <Tab title="API">
            To retrieve the prompt via an API request, Refer to the [**GET Prompt**](/latest/api-reference/endpoint/openai/openlit/prompt-hub/get) API Reference Documentation.
          </Tab>
        </Tabs>
      </Step>
    </Steps>
