    ...
    <Steps>
      ...
      <Step title="Get secret(s) using the SDK">
        <Tabs>
          ...
          <Tab title="API">
            To retrieve the secret via an API request, Refer to the [**GET Secret(s)**](/latest/api-reference/endpoint/openai/openlit/vault/get) API Reference Documentation.
          </Tab>
        </Tabs>
      </Step>
    </Steps>
